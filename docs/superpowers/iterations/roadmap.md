...
| ITER-0008 Streaming observability | in progress (session-error component verified) | Maintained SSE, complete parallel/interview event families, auth-no-retry and ordered terminal shutdown flush; typed errors/context-overflow recovery component verified | ATTR-SERVER-01, ATTR-OBS-01, CAL-ERROR-01 | SCN-SSE-LIVE, SCN-EVENT-FAMILIES, SCN-CAL-FAILURE-SHUTDOWN |
