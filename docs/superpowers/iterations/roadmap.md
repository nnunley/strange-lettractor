...
| ITER-0009 Environment and prompt bounds | partial (execution environment complete 2026-09-08) | Raw/model truncation, provider-filtered 32 KiB project-instruction budget, runtime/git/model-metadata prompt snapshots and the FAIL retry-contract decision (2026-09-08) verified; exact execution-environment contract and sourced catalog cutoff coverage remain pending `SCN-CAL-ENV` complete: 15/117/0; sourced catalog cutoff coverage still pending. | CAL-ENV-01, CAL-TOOLS-01, CAL-TRUNC-01, CAL-SYSTEM-01, ATTR-ENG-04 | SCN-CAL-ENV, SCN-CAL-TRUNCATION, SCN-SYSTEM-PROMPT-BOUND, SCN-FAIL-RETRY-CONTRACT |
