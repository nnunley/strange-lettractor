...
| SCN-PINNED-RECOVERY | public pipeline/checkpoint/server integration | impacted | `rg -q '^;; SCN-PINNED-RECOVERY COMPLETE$' test/attractor/workflow_recovery_contract_test.lg && LGX_LG=/Users/ndn/development/let-go/lg lgx test test/attractor/workflow_recovery_contract_test.lg` | pending in ITER-0004 |
...
| SCN-PIPELINE-COMPOSITION | public pipeline/engine integration | impacted | `rg -q '^;; SCN-PIPELINE-COMPOSITION COMPLETE$' test/attractor/composition_contract_test.lg && LGX_LG=/Users/ndn/development/let-go/lg lgx test test/attractor/composition_contract_test.lg` | pending in ITER-0005 |
...
| SCN-FIRST-SUCCESS | concurrency integration | impacted | `rg -q 'SCN-FIRST-SUCCESS' test/attractor/interactive_contract_test.lg && LGX_LG=/Users/ndn/development/let-go/lg lgx test` | pending ITER-0006 |
...
| SCN-FANIN-RANKING | handler/LLM integration | impacted | `rg -q 'SCN-FANIN-RANKING' test/attractor/interactive_contract_test.lg && LGX_LG=/Users/ndn/development/let-go/lg lgx test` | pending ITER-0006 |
| SCN-HANDLER-MATRIX | engine integration | impacted | `rg -q 'SCN-HANDLER-MATRIX' test/attractor/interactive_contract_test.lg && LGX_LG=/Users/ndn/development/let-go/lg lgx test` | pending ITER-0006 |
