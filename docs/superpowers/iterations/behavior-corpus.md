...
| SCN-PUBLIC-LIFECYCLE | public pipeline/CLI/server integration | impacted | `rg -q '^;; SCN-PUBLIC-LIFECYCLE COMPLETE$' test/attractor/lifecycle_contract_test.lg && LGX_LG=/Users/ndn/development/let-go/lg lgx test test/attractor/lifecycle_contract_test.lg` | pending ITER-0002; pipeline core proved, CLI/server adoption remains |
